SELECT 'POOL' as source, id, card_serial, selected_at, room, status, game_session_id FROM bingo_cards_pool WHERE selected_by = 1040 ORDER BY selected_at DESC LIMIT 5;
