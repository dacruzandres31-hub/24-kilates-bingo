...
celebrationAudio.volume = 0.7;
  ...
  // Función para obtener color según el número - Paleta Plateada con contraste
  const getBallColor = (number) => {
    ...
    if (number >= 21 && number <= 30) return '#6d6d6d'; // Gris carbón
  ...
  // PREMIO ÚNICO: Solo celebrar si lineWinnersPaid === false (premio aún disponible)
