...
const CardPurchaseCalculator = ({ isOpen, onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            alert('✅ Solicitud de compra enviada. Tus cartones se acreditarán una vez aprobada por tu agente.');
            onClose();
        } catch (error) {
                ...
                <div style={{ padding: '2rem' }}>
                    {loading ? (
                        ...
                        <form onSubmit={handleSubmit} className="animate-fade-in">
                            <h3 style={{ color: 'white', marginBottom: '1.5rem', textAlign: 'center' }}>Transferir a tu Agente</h3>
