...
class AudioService {
  constructor() {
    ...
    this.lowerVolume = 0.04; // ~25% del volumen normal (más agresivo para que se escuche el bolillero)
    this.enabled = true;
    ...
    // Web Audio Context para sonidos sintéticos (clicks ruleta)
    this.audioCtx = null;
  }
  ...
  playWheelClick() {
    ...
    try {
      ...
      // Sonido de "click" metálico corto
      osc.type = 'triangle';
