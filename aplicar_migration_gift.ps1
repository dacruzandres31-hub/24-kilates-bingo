# Script simple para aplicar migración de gift_cards
# Fecha: 13-DIC-2025
...
$tempFile = "temp_gift_migration.sql"
...
Write-Host "`n🔍 Verifica las columnas con: mysql -u root -p bingo_24k -e ""DESC users;""" -ForegroundColor Cyan
