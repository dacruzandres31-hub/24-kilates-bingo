...
const ResourceSummary = ({
    ...
    // Detectar superadmin por rol o por username (Andy)
    const isSuperAdmin = currentUser.role === 'superadmin' || 
                         currentUser.username?.toLowerCase() === 'andy';
    
    console.log('🔍 ResourceSummary - currentUser:', currentUser, 'isSuperAdmin:', isSuperAdmin);
    ...
    return (
        <div className="mb-6 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl p-6 shadow-lg">
            ...
            <div className={`grid gap-4 ${isSuperAdmin ? 'grid-cols-2 md:grid-cols-4' : 'grid-cols-2 md:grid-cols-4'}`}>
